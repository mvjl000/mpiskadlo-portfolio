export const AboutMe = () => {
  ...
  return (
    <div className="mt-16 mx-auto w-[95%] max-w-[1200px] lg:w-[75%] 2xl:w-[65%] min-h-[300px] bg-neutral-900 border-neutral-800 border-2 rounded-lg flex flex-col justify-start overflow-hidden font-montserrat">
      ...
      <div className="px-5 pb-10 text-default-font font-montserrat">
        <h2 className="mt-3 font-[500] text-lg lg:text-xl 2xl:text-2xl">
          Hi, Miłosz here 👋
        </h2>
        <p className="mt-2 text-md xl:text-lg">
        ...
        <h3 className="mt-3 font-[500] text-lg lg:text-xl">Some quick info:</h3>
        <ul className="mt-2 flex flex-col gap-3 pl-5 list-disc text-md 2xl:text-lg">
          <li>
